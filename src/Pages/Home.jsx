...
function Home() {
  const SOCIAL_LINKS = [
    { icon: Github, link: "https://github.com/GM-6120" },
    { icon: Linkedin, link: "www.linkedin.com/in/ghulam-mustafa-software-engineer" },
    { icon: Mail, link: "mailto:gm393027@gmail.com" },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center h-auto lg:h-screen">
        ...
        >
          ...
          <p
            ...
            data-aos-delay="1000"
          >
            I&apos;m a passionate Flutter Developer and AI/ML enthusiast with
            experience in cross-platform app development, machine learning model
            integration, and WordPress-based SEO-optimized website building. I
            combine tech with creativity to craft performance-driven solutions
            for modern digital platforms. Let&apos;s turn ideas into impactful
            products.
          </p>
          <div
