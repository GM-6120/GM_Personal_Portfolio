...
const AboutEducationResume = () => {
  ...
  return (
    <div
      className="container mx-auto px-6 lg:px-12 max-w-screen-xl py-16 space-y-16"
      id="AboutEducationResume"
    >
      {/* About Me Section */}
      <section data-aos="fade-up" data-aos-delay="200">
        <h2 className="text-3xl font-bold text-white mb-4">About Me</h2>
        <p className="text-gray-300 leading-relaxed">
          I am a passionate developer with experience across multiple domains including Flutter development, AI/ML model integration, WordPress customization, and SEO optimization. With a strong foundation in programming and problem-solving, I enjoy turning ideas into meaningful digital experiences. Whether it's building cross-platform apps or analyzing data for smart insights, I believe in combining technology with creativity.
        </p>
      </section>
        ...
        <div className="space-y-6">
          <div className="border-l-4 border-blue-500 pl-4">
            ...
            <p className="text-gray-300 mt-2">
              Focused on software development, machine learning, and data-driven projects. Developed a Final Year Project on AI-based soil monitoring system using Python, GEE & Flutter.
            </p>
          </div>
        </div>
      </section>
      ...
      <section data-aos="fade-up" data-aos-delay="400">
        ...
        <p className="text-gray-300 mb-4">
          You can view or download my resume for a detailed overview of my experience, skills, and projects.
        </p>
        <a
          href="/Resume.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 bg-gradient-to-r from-[#21365b] to-[#184455] text-white px-5 py-2 rounded-lg hover:scale-105 transition-transform"
        >
...
export default AboutEducationResume;
...
//     Github: "https://github.com/GM-6120/gm-portfolio",
