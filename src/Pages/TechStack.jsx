...
function TechStack() {
  ...
  const techStacks = [
  { icon: "flutter.svg", language: "Flutter", Knowledge: 90 },
  { icon: "dart.svg", language: "Dart", Knowledge: 88 },
  { icon: "python.svg", language: "Python", Knowledge: 85 },
  { icon: "tensorflow.svg", language: "TensorFlow", Knowledge: 80 },
  { icon: "c++.svg", language: "C++", Knowledge: 86 },
  { icon: "html.svg", language: "HTML", Knowledge: 90 },
  { icon: "css.svg", language: "CSS", Knowledge: 80 },
  { icon: "javascript.svg", language: "JavaScript", Knowledge: 82 },
  { icon: "mongodb.svg", language: "MongoDB", Knowledge: 80 },
  { icon: "wordpress.svg", language: "WordPress", Knowledge: 88 },
  { icon: "seo.png", language: "SEO", Knowledge: 90 },
  { icon: "git.svg", language: "Git", Knowledge: 80 },
];
